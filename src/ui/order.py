...
# Form implementation generated from reading ui file 'src/ui/order.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBoxOrder = QtWidgets.QComboBox(self.widget)
        self.comboBoxOrder.setObjectName("comboBoxOrder")
        self.horizontalLayout.addWidget(self.comboBoxOrder)
